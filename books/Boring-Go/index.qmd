...
| 16 | `16-data-structures-and-algorithms` | Big-O, stacks, queues, linked lists, BSTs, heaps, tries, sorting, searching, graphs, Dijkstra, Bloom filters |
| 17 | `17-performance-engineering` | Preallocation, object pooling, struct alignment, escape analysis, interface boxing, zero-copy, GC limits, atomics, batching, PGO |
| 18 | `18-network-performance` | Netpoller, HTTP client connection pooling, 10k connections, backpressure & load shedding, long-lived sockets, SO_REUSEPORT, TLS & DNS tuning |
