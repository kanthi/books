...
def fix_bash_arrays_comprehensive(filepath):
    """Comprehensively fix bash array syntax that causes LaTeX math interpretation issues."""
    ...
    for line in lines:
        ...
        if in_code_block:
            # Fix all common bash array patterns
            # Pattern: ${array[@]} -> \${array[@]}
    ...
    for filepath in qmd_files:
        ...
        with open(filepath, 'r', encoding='utf-8') as f:
            ...
            if '${' in content and '[@]' in content:
                ...
                fix_bash_arrays_comprehensive(filepath)

    print("All files processed comprehensively!")
