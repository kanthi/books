...
Why Git is the one-page argument. This chapter is the history: SCCS and RCS on one disk, CVS and Subversion as a server, Git as a graph on every clone. Forges (GitHub, GitLab) are products on top of Git — later parts of this book.
