...
Go 1.27 requires **macOS 13 Ventura or later**. Linux and Windows binaries from [go.dev/dl](https://go.dev/dl) remain the supported install path; always pick the current patch (1.27.1 at this writing).
