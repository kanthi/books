...
Use this checklist when upgrading existing projects to Go 1.27 (from 1.26 or earlier). Go 1.25 is out of support as of the 1.27 release. Feature-by-feature notes and runnable samples: [What's New in Go 1.27](01e-whats-new-in-go-1-27.qmd) ([official release notes](https://go.dev/doc/go1.27)).
...
- Goroutine count (and the leak profile if you enable pprof)
