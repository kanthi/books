...
Runtime details evolve (scheduler, GC, maps, experiments). Chapters teach **stable models** and version-labeled notes (e.g. Go 1.26 Green Tea GC, P-syscall simplification). Pseudocode is a map for reading source — not a bit-identical clone of `src/runtime`.
