...
**Try next:** Read Go 1.26 release notes scheduler section alongside [GMP scheduler](201-scheduler-gmp-deep-dive.qmd). For the *deployment* cost of cgo (libc, Alpine, `scratch`), start at [Go as a Systems Language](../14-systems-programming/140a-go-as-systems-language.qmd).
