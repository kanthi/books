...
|---------|--------|---------|
| 140a Go as a systems language | No libc on Linux, `CGO_ENABLED=0`, Go vs C | Why a Go binary runs on Alpine, `scratch`, and NixOS |
...
- How Go reaches the kernel / static binaries: [140a Go as a Systems Language](140a-go-as-systems-language.qmd)
