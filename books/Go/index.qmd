...
- **Go 1.27:** language (generic methods, promoted field keys), toolchain, json/v2, `uuid`, `goroutineleak`, SIMD experiment. Official notes: [go.dev/doc/go1.27](https://go.dev/doc/go1.27).
