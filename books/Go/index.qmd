...
- **Systems programming:** Processes, signals, safe filesystem I/O, Unix pipeline CLIs; env/CWD/umask; file descriptors; mmap; Unix domain sockets; flock/pidfiles; time/timers; config watch/reload; PTYs; rlimit/`GOMEMLIMIT`; least privilege; ops logging; projects **systool** + **sysops**.
...
- **Wire formats:** JSON, CSV, XML, base64/hex; binary frames, gob, PEM.
