...
- **Language Building Blocks:** Variables, types, and functions. <span class="badge badge-info">New in 1.26: `new(T)` values</span>
...
- **Memory Optimization:**
    ...
    - Garbage Collection (GC) tuning and `GOMEMLIMIT`. <span class="badge badge-success">New in 1.26: Green Tea GC</span>
...
- **The Modern Toolkit:**
    ...
    - `go fix` modernizers. <span class="badge badge-info">New in 1.26</span>
...
- **Security Tools:** `govulncheck`, `gosec`, `capslock`, and `nilaway`.
    - `crypto/hpke` & `runtime/secret`. <span class="badge badge-warning">New in 1.26</span>
...
- **Machine Learning:** Building LLM-powered applications in Go.
    - `simd` package (Experimental). <span class="badge badge-warning">New in 1.26</span>
