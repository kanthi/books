...
| 6 | `06-nixos-system` | Modules, first machine, systemd, firewall, users, hardware, Disko, impermanence, generators, backups and GC windows, systemd Stage 1 initrd, dbus-broker, system.nix, switch inhibitors, activation reload/restart deprecation |
