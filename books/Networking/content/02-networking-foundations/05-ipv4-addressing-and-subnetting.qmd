...
Parent: `192.168.10.0/24` (256 addresses). Split into four `/26`s (64 addresses each):
...
4. From `10.50.0.0/16`, carve three `/24`s and one `/28` for a mgmt VLAN without overlap  
