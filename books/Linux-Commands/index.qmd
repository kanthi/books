...
Short utilities may use a lighter form (overview + a few examples + related). See `content/_planning/command-page-template.md` for author depth tiers (Core / Standard / Light).
...
| **Shell commands** | `echo`/`printf`, history, `type`/`command`, `export`, `time`, directory stack |
...
1. Use a **numeric prefix** plus lowercase command name (`18-jq.md`, `05-zstd.md`) so sidebar order stays pedagogical.
