...
| 5 | `05-collections` | lists, tuples, strings, t-strings, dicts, sets, dataclasses |
...
| 17 | `17-data-structures-and-algorithms` | Big-O, stacks, queues, linked lists, BSTs, heaps, tries, sorting, bisect, graphs, Dijkstra, Bloom filters |
