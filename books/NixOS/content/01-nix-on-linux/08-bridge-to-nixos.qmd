...
1. Install NixOS (graphical or minimal) — [Install](../02-nixos-host/01-install.qmd)  
2. Put host in a flake — [Flake host](../02-nixos-host/02-flake-host.qmd)  
3. `nixos-rebuild switch --flake .#hostname`  
4. Break sshd/firewall intentionally; roll back a generation — [Rebuild and generations](../02-nixos-host/03-rebuild-and-generations.qmd)  
...
- [ ] You are ready for part `02-nixos-host/` without relearning store/flakes  

---

## Further depth

- [NixOS host index](../02-nixos-host/00-index.qmd)  
- [Flake layout](../03-home-and-flake-layout/01-flake-layout.qmd)  
- [Home Manager](../03-home-and-flake-layout/03-home-manager.qmd)  
- Capstone rebuild proof later: `08-capstone/`
