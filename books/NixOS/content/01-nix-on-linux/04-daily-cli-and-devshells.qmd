...
When you add packaging later, `checks` become richer ([flake checks](../03-home-and-flake-layout/08-flake-checks.qmd)).
...
- [direnv chapter in Home layout](../03-home-and-flake-layout/06-direnv-devshell.qmd)
