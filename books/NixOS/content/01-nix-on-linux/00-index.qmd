...
| Next | Part |
|------|------|
| Install and own a machine | `02-nixos-host/` |
| Flake layout + HM as system module | `03-home-and-flake-layout/` |
| Packaging craft | `05-packaging/` |
| **ROS 2 robotics env** (overlay + flakes) | [ROS 2 with nix-ros-overlay](../05-packaging/12-ros2-nix-ros-overlay.qmd) |
