...
It is an **overlay** on a specific nixpkgs pin (the overlay *follows its own nixpkgs*). Treat it like a specialized ecosystem helper—related to [language ecosystems](03-language-ecosystems-a.qmd) and [overlays](../04-home-and-flake-layout/09-overlays-light.qmd), not like `environment.systemPackages = [ ros-desktop-full ]` on every laptop forever.
...
Same [direnv discipline](../04-home-and-flake-layout/06-direnv-devshell.qmd) as any other project shell—plus larger GC roots. Prune unused roots when disk hurts.
...
If you followed [Nix on Linux](../02-nix-on-linux/00-index.qmd):
...
| Topic | Chapter |
|-------|---------|
| Overlays mechanism | [Overlays (light)](../04-home-and-flake-layout/09-overlays-light.qmd) |
| Project shells | [direnv and devShells](../04-home-and-flake-layout/06-direnv-devshell.qmd) |
| Language packaging patterns | [Ecosystems A/B](03-language-ecosystems-a.qmd) |
| Caches | [Binary caches](09-binary-caches.qmd) |
| Fedora dual-stack | [Nix on Linux](../02-nix-on-linux/00-index.qmd) |
