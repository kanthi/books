...
Large third-party overlays (for example **[nix-ros-overlay](../06-packaging/12-ros2-nix-ros-overlay.qmd)** for ROS 2) use the same mechanism at ecosystem scale: you import *their* overlay and usually **`nixpkgs.follows`** their pin so the world stays coherent.
