...
| Module functions in production | Host: [Modules as a consumer](../03-nixos-host/08-modules-as-consumer.qmd), [Writing custom modules](../03-nixos-host/09-custom-modules.qmd) |
