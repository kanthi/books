...
**On Fedora 44+:** prefer the **official distro package** (`sudo dnf install nix`) and the full dual-stack bridge in **[Nix on Linux](../02-nix-on-linux/00-index.qmd)** rather than only a generic upstream installer—SELinux and `/nix` integration are why Fedora packaged it.
:::
