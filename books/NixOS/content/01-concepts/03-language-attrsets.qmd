...
| Module merge (not `//`) | Host: [Modules as a consumer](../03-nixos-host/08-modules-as-consumer.qmd) |
| Real host config trees | Host: [Flake-defined hosts](../03-nixos-host/02-flake-host.qmd) |
