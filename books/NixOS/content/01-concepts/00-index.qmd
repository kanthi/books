...
| This part | Next part |
|-----------|-----------|
| Language + store + flakes literacy | **Nix on Linux** (`01-nix-on-linux/`) — Fedora 44+ dual-stack bridge (recommended) |
...
|-----------------|-------|
| **Fedora / foreign distro daily driver** | Part **Nix on Linux** (`01-nix-on-linux`) — official Fedora Nix, HM standalone, dual-stack |
