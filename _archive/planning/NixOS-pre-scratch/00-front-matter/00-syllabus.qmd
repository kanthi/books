...
::: {.callout-tip}
**Exploring alternatives:** this page is the current working syllabus (**A**).  
Additional outlines for comparison: Syllabus 1–7 and the options index (same part in the sidebar).  
Planning copies live under `content/_planning/`.
:::
